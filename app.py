...
st.markdown("""
	...
	.stButton>button {background: #2563eb; color: white; border-radius: 6px;}
...
# --- Sidebar: API Key and Context Management ---
st.sidebar.title("🔑 OpenAI API Key & Context")
...
# --- Main UI ---
st.title("📄 Chat with Your Document Using Codanics Application")
st.write("Upload a .txt file and chat with its content using OpenAI's LLM.")
...
if uploaded_file:
	...
	try:
		# For PDF/DOCX, need to reset file pointer after reading
...
with st.form("chat_form", clear_on_submit=True):
	user_query = st.text_input("Your question about the document:", key="user_query")
